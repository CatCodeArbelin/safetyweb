...
TEST_MODE используется только для проверки выдачи и продления цифрового доступа. Он не создаёт реальные платежи, не выдаёт скидку раннего покупателя и не засчитывается в реферальную программу.
