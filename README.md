...
Первые 100 пользователей, совершившие успешную оплату, получают постоянную скидку на следующие оплаты.

Скидка привязывается к Telegram ID пользователя после первой успешной оплаты. Начиная со следующей заявки на оплату, бот показывает базовую цену, процент скидки и итоговую сумму.
